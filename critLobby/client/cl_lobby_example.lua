...
TriggerEvent('lobbymenu:AddListButton', 'critMenu.ExampleMenu', {}, "Button #1", {"Item #1","Item #2","Item #3","Item #4","Item #5","Item #6"}, "lobby.AddPlayerToMenu")
TriggerEvent('lobbymenu:AddStandardButton', 'critMenu.ExampleMenu', {text = "Showing button 2"}, "Button 2", "", false, 0, "lobby.AddDetailsToMenu")
TriggerEvent('lobbymenu:AddDisabledButton', 'critMenu.ExampleMenu', {text = "Showing button 3"}, "Button 3", "", false, 0, "lobby.AddWarningToMenu")
TriggerEvent('lobbymenu:AddValuesButton', 'critMenu.ExampleMenu', {id = 0, text = "Button Used"}, "Close Menu", "", false, 0, "lobbymenu:CloseMenu")
TriggerEvent('lobbymenu:AddFlickeringButton', 'critMenu.ExampleMenu', {text = "Button Used"}, "Close Menu", "", false, 0, "lobbymenu:CloseMenu")
